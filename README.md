 ...
 <h2> Port address translation (PAT). </h2>
    >> Pat is a type of DNAT that was developed to increase the scalability of NAT.
       ...
       <h2> The Nat terminology. </h2>
           ...
           <i> Outside global address: </i> a public address referencing an outside device
           <li> The public UP address assigned to a device outside of the local network.
           <i> Outside local address: </i> a private IP address assigne to an outside device. 
...
# WAN technologies 1.
      <li> Public switched telephone network
        <li> Broadband cable.
          <li> Fiber
